...
public class kelas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Uang yg di berikan");
    ...
    private void HitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HitungActionPerformed
      int jumlah=Integer.parseInt(p1.getText()) * Integer.parseInt(p2.getText());
      total.setText(""+jumlah);
      
      int kembalian=Integer.parseInt(p3.getText()) - Integer.parseInt(total.getText());
